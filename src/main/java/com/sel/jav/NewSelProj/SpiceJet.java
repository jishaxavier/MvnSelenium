...
public class SpiceJet {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		adultCount= driver.findElement(By.id("ctl00_mainContent_ddl_Adult"));
		Select adultSelect = new Select(adultCount);
		adultSelect.selectByValue("4");
		//Child Count
		WebElement childCount;
		childCount = driver.findElement(By.id("ctl00_mainContent_ddl_Child"));
		Select childSelect = new Select(childCount);
		childSelect.selectByValue("2");
		//Infant Count
		WebElement infantCount;
		infantCount = driver.findElement(By.id("ctl00_mainContent_ddl_Infant"));
